...
import com.s.passengerapp.Model.PassengerInfoModel;
...
public class SplashScreenActivity extends AppCompatActivity {
    ...
    private void delaySplashScreen() {
        Completable.timer(3, TimeUnit.SECONDS,
                ...
                .subscribe(() -> startActivity(new Intent(getApplicationContext(), MainActivity.class))
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            ...
                            PassengerInfoModel passengerInfoModel = snapshot.getValue(PassengerInfoModel.class);
                            goToHomeActivity(passengerInfoModel);
                        } else {
                            showRegisterLayout();
                        }
                    }
    ...
    private void showRegisterLayout() {
        ...
        btn_continue.setOnClickListener(v -> {
            ...
            } else if(TextUtils.isEmpty(edt_phone_number.getText().toString()))
            {
                ...
                PassengerInfoModel model = new PassengerInfoModel();
    ...
    private void goToHomeActivity(PassengerInfoModel passengerInfoModel) {
        Common.currentUser = passengerInfoModel;
        //delaySplashScreen();
        startActivity(new Intent(SplashScreenActivity.this, PassengerHomeActivity.class));
        finish();
    }
}